<div class="wcc-settings-title">
    ...
    <span><?php echo e(_wpcc('Category mapping and other settings to be used when crawling category pages')); ?></span>
</div>
...
<table class="wcc-settings">
    ...
    <tr>
        ...
        <td><?php echo $__env->make('form-items/text', ['name' => '_category_list_page_url', 'type' => 'url'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?></td>
    </tr>
    ...
    <tr>
        ...
        <td><?php echo $__env->make('form-items/text', ['name' => '_test_url_category', 'type' => 'url'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?></td>
    </tr>
    ...
    <?php echo $__env->make('partials.table-section-title', ['title' => _wpcc("Next Page")], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    ...
    <?php echo $__env->make('partials.table-section-title', ['title' => _wpcc("Featured Images")], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    ...
    <tr id="category-thumbnail-test-url">
        ...
        <td><?php echo $__env->make('form-items/text', ['name' => '_test_find_replace_thumbnail_url_cat'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?></td>
    </tr>
